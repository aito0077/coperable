$(document).ready(function() {
	...
	updatePolicy: function(){
	    ...
	    POLICY_JSON = { "expiration": "2013-12-01T12:00:00.000Z",
			    "conditions": [
	...
	initialize: function() {
        ...
        this.template =  _.template($("#image-file-template").html());
	},
	...
	initialize: function() {
        ...
        this.template = _.template($("#image-meta-template").html());
	},
	...
	initialize: function() {
	    _.bindAll(this, 'render');
        console.log($("#image-preview-template").html());
        this.template = _.template($("#image-preview-template").html());
	    this.model.bind('change', this.render);
	},
